<?php 
  class Config
  {
	  ...
	  public static $_MERCHANT_ID = "17185";
	  public static $_MERCHANT_PASSWORD = "123456789";
	  public static $_EMAIL_RECEIVE_MONEY = "kieunghia.luckystar@gmail.com";
	  /*public static $_MERCHANT_ID = pzk_config('merchant_id');
	  public static $_MERCHANT_PASSWORD = pzk_config('merchant_pass');
	  public static $_EMAIL_RECEIVE_MONEY = pzk_config('nganluong_merchant');	*/
