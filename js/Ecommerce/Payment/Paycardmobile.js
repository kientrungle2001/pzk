PzkEcommercePaymentPaycardmobile = PzkObj.pzkExt({
		...
		$.ajax({
			...
			success: function(result)
			{
				...
				if(res[1]=="ok")
				{
					...
					$('#pm_result_ok').html('<span class="glyphicon glyphicon-ok"></span><span>  Bạn đã nạp thẻ thành công số tiền'+ res[0]+'</span>');
				  $('#pm_result_ok').show();
        }
				else{
