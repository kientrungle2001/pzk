<div class="row">
	...
	<div class="col-md-11 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-12">
		...
		<p><strong>Bước 1: Nạp tiền vào tài khoản bằng thẻ cào</strong></p>
		<ul>
	...
	<?php if(pzk_session('userId')){ ?>
	  <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-12">
		<h3><strong>Tài khoản của bạn hiện có : </strong> <span class="label label-danger" id="wallet_money"><?php echo product_price(pzk_user()->getWallets(pzk_session('userId'))); ?></span></h3>
	  </div> 
	 <?php } ?>
</div>
<script>
