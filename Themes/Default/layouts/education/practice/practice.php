...
<div class="container" id="subject">
	<div class="row fivecolumns">
		<div class="col-md-2 col-xs-4  pd-40">
			<div class="thumbnail fxheight btn-custom3 text-color text-uppercase weight-12 text-center sharp">
				<div class="fiximg">
				<a href="#" onclick ="return false;" class="subjectclick" data-subject="52"><img src="<?=BASE_SKIN_URL?>/Default/skin/nobel/Themes/Story/media/khoahoc.png" alt="Khoa học" class="img-thumnail"></a>
				</div>
				<div class="hfix">
				<p class="pd-50">Science</p>
				<p>(Khoa học)</p>
				</div>
			</div>
		</div>
		<div class="col-md-2 col-xs-4  pd-40">
			<div class="thumbnail fxheight btn-custom3 text-color text-uppercase weight-12 text-center sharp">
				<div class="fiximg">
				<a href="#" onclick ="return false;" class="subjectclick" data-subject="51"><img src="<?=BASE_SKIN_URL?>/Default/skin/nobel/Themes/Story/media/toan.png" alt="Toán" class="img-thumnail"></a>
				</div>
				<div class="hfix">
				<p class="pd-50">Maths</p>
				<p>(Toán)</p>
				</div>
			</div>
		</div>
		<div class="col-md-2 col-xs-4  pd-40">
			<div class="thumbnail fxheight btn-custom3 text-color text-uppercase weight-12 text-center sharp">
				<div class="fiximg">
				<a href="#" onclick ="return false;" class="subjectclick" data-subject="50"><img src="<?=BASE_SKIN_URL?>/Default/skin/nobel/Themes/Story/media/dialy.png" alt="Địa lý" class="img-thumnail"></a>
				</div>
				<div class="hfix">
				<p class="pd-50">Geography</p>
				<p>(Địa lý)</p>
				</div>
			</div>
		</div>
		<div class="col-md-2 col-xs-4  pd-40">
			<div class="thumbnail fxheight btn-custom3 text-color text-uppercase weight-12 text-center sharp">
				<div class="fiximg">
				<a href="#" onclick ="return false;" class="subjectclick" data-subject="88"><img src="<?=BASE_SKIN_URL?>/Default/skin/nobel/Themes/Story/media/kynangquansat.png" alt="Kỹ năng quan sát" class="img-thumnail"></a>
				</div>
				<div class="hfix">
				<p class="pd-50">Observation Skill</p>
				<p>(Kỹ năng quan sát)</p>
				</div>
			</div>
		</div>
		<div class="col-md-2 col-xs-4  pd-40">
			<div class="thumbnail fxheight btn-custom3 text-color text-uppercase weight-12 text-center sharp">
				<div class="fiximg">
				<a href="#" onclick ="return false;" class="subjectclick" data-subject="53"><img src="<?=BASE_SKIN_URL?>/Default/skin/nobel/Themes/Story/media/lichsu.png" alt="Lịch sử" class="img-thumnail"></a>
				</div>
				<div class="hfix">
				<p class="pd-50">History </p>
				<p>(Lịch sử)</p>
				</div>
			</div>
		</div>
		<div class="col-md-2 col-xs-4  pd-40">
			<div class="thumbnail fxheight btn-custom3 text-color text-uppercase weight-12 text-center sharp">
				<div class="fiximg">
				<a href="#" onclick ="return false;" class="subjectclick" data-subject="160"><img src="<?=BASE_SKIN_URL?>/Default/skin/nobel/Themes/Story/media/tienganh.png" alt="Tiếng Anh" class="img-thumnail"></a>
				</div>
				<div class="hfix">
				<p class="pd-50">English</p>
				<p>(Tiếng Anh)</p>
				</div>
			</div>
		</div>
		<div class="col-md-2 col-xs-4  pd-40">
			<div class="thumbnail fxheight btn-custom3 text-color text-uppercase weight-12 text-center sharp">
				<div class="fiximg">
				<a href="#" onclick ="return false;" class="subjectclick" data-subject="87"><img src="<?=BASE_SKIN_URL?>/Default/skin/nobel/Themes/Story/media/kynangnghe.png" alt="Kỹ năng nghe" class="img-thumnail"></a>
				</div>
				<div class="hfix">
				<p class="pd-50">Listening Skill</p>
				<p>(Kỹ năng nghe)</p>
				</div>
			</div>
		</div>
		<div class="col-md-2 col-xs-4  pd-40">
			<div class="thumbnail fxheight btn-custom3 text-color text-uppercase weight-12 text-center sharp">
				<div class="fiximg">
				<a href="#" onclick ="return false;" class="subjectclick" data-subject="54"><img src="<?=BASE_SKIN_URL?>/Default/skin/nobel/Themes/Story/media/ngonngu.png" alt="Ngôn ngữ và giao tiếp" class="img-thumnail"></a>
				</div>
				<div class="hfix">
					<p class="pd-50">Language& <br>Communication</p>
					<p>(Ngôn ngữ và giao tiếp)</p>
				</div>
			</div>
		</div>
		<div class="col-md-2 col-xs-4  pd-40">
			<div class="thumbnail fxheight btn-custom3 text-color text-uppercase weight-12 text-center">
				<div class="fiximg">
				<a href="#" onclick ="return false;" class="subjectclick" data-subject="59"><img src="<?=BASE_SKIN_URL?>/Default/skin/nobel/Themes/Story/media/hieubiet.png" alt="Hiểu biết xã hội" class="img-thumnail"></a>
				</div>
				<div class="hfix">
				<p class="pd-50">Social Understanding</p>
				<p>(Hiểu biết xã hội)</p>
				</div>
			</div>
		</div>
	</div>
...
<div class="container pdbot-60">
	<div class="row ajaxchangepractice">
		<?php $numberclass = intval(pzk_request()->getClass()); ?>
		<?php if(!$numberclass):?>
		<?php for($i = 18; $i>1; $i--){ ?>
