				...
				<form id="form_question_nn" class="question_content pd-0 item mgb15 form-horizontal bd-div bgclor" method="post">
					...
					<div class="fix_da">
							...
							<?php $check = pzk_session('signActive');
								...
								<a id="view-rating" class="btn btn-info" name="view-rating" type="button" style="display: none;"  href="<?=BASE_REQUEST?>/Home/rating">
									Xếp hạng 
								</a>
								
								<button id="show-answers" class="btn btn-danger" name="show-answers" style='display:none' onclick="show_answers();" type="button">
									Xem đáp án 
								</button>
	...
	<div class="modal-dialog">
      	<div class="modal-content">
	        ...
	        <div class="modal-footer">
				<button class="btn btn-danger" name="show-answers" onclick="show_answers();$('#exampleModal').modal('hide');" type="button">
									Xem đáp án 
						</button>
