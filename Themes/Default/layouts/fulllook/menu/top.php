	        ...
	        <li class="dropdown bdr">
		        ...
		        <ul class="nav nav-tabs nav-tabs-ct">
				   ...
				   <div class="row tab-pane fade in active text-center pding10" id="home">
						...
						<div class="col-md-2 col-xs-3 top10 height80 width20 btn-custom3 bgcl choicesubject" onclick="return false;" data-class="3" data-subject="160">
...
<script>
	...
	$(".choiceclass").click(function(){
		...
		window.location = BASE_REQUEST+'/home/practice?class='+numberclass;
	});
	$(".choicesubject").click(function(){
		var numbersubject = $(this).data("subject");
		var subclass = $(this).data("class");
		window.location = BASE_REQUEST+'/home/detail/'+numbersubject+'?class='+subclass;
	});
	$(".choicepractice").click(function(){
		var numbertest = $(this).data("number");
		var numclass = $(this).data("class");
		window.location = BASE_REQUEST+'/home/test/'+numbertest+'?practice=1&class='+numclass;
	});
	$(".choicetest").click(function(){
		var numbertest = $(this).data("number");
		var numclass = $(this).data("class");
		window.location = BASE_REQUEST+'/home/test/'+numbertest+'?practice=0&class='+numclass;
	});
	$(".choicedocument").click(function(){
		var numbersubject = $(this).data("subject");
		var subclass = $(this).data("class");
		window.location = BASE_REQUEST+'/home/document/'+numbersubject+'?class='+subclass;
	});
	$(".otherpractice").click(function(){
		var subclass = $(this).data("class");
		window.location = BASE_REQUEST+'/home/test?practice=1&class='+subclass;
	});
	$(".othertest").click(function(){
		var subclass = $(this).data("class");
		window.location = BASE_REQUEST+'/home/test?practice=0&class='+subclass;
	});
</script>