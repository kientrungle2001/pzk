...
<div class="hidden-xs">
        <ul class="header-menu item">
	        ...
	        <li class="dropdown colormenu2">
	            <a href="/#practice" class="dropdown-toggle  jumping" rel="#A0D4CE" data-class="5" data-jumping="practice" >Thi năng lực theo môn </a>
			...
			<li class="dropdown colormenu4 tab-content">
	            <a href="/#test" class="dropdown-toggle fsize" data-class="<?php echo pzk_session('lop') ?>" data-jumping="test" rel="#E0C7A3" >Thi tổng hợp</a>
	            <div class="dropdown-menu multi-column columns-3 tab-content">
					<ul class="nav nav-tabs nav-tabs-ct2">
						<li class="active" ><a data-toggle="tab" href="#menu23">Thi tổng hợp</a></li>
						<li <?php if($lang == 'ev'){
