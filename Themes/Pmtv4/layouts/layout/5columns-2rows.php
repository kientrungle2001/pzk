...
<div class="container top-25 bottom-25">
	<div class="row">
		<div class="col-xs-12">
			<div class="header <?php echo $data->getBgcolor()?>-bold">
			...
			<div class="row" id="carousel-<?php echo @$data->id?>">
				...
				<div class="col-sm-15 col-xs-6 top-10">
					<h3 class="<?php echo $data->getBgcolor()?> text-center margin-0 padding-10 auto-font"><a class="color-white auto-font text-bold" style="display: inline-block; width: 100%; height: 15px; overflow: hidden;" href="/<?php echo @$item['alias']?>"><?php echo @$item['name']?></a></h3>
				</div>
				<?php  endforeach;?>
			</div>
		</div>
