		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2 col-xs-12 box news-box">
				  ...
				  <div id="video" class="video-wrapper">
					...
					<video id="my-video" class="video-js vjs-16-9 vjs-big-play-centered" controls preload="auto" width="700" height="390"
					  poster="<?php echo pzk_or(@$item['video_image'], '/Themes/pmtv4/skin/media/video-player.png'); ?>" data-setup="{}">
						<source src="/stream/video/<?php echo $file;?>/{time}/{token}/" type='video/mp4'>
					...
					<?php else: ?>
					<iframe border="0" style="width: 100%; height: 400px;" src="{? echo PMTV4_URL; ?}/demo.php?video=video-{file}-0"></iframe>
					<?php endif; ?>
				  ...
				  <div id="video{i}" class="video-wrapper" style="display: none;">
					...
					<video id="my-video-{i}" class="video-js vjs-16-9 vjs-big-play-centered" controls preload="auto" width="700" height="390"
					  poster="<?php echo pzk_or(@$item['video'.$i.'_image'], '/Themes/pmtv4/skin/media/video-player.png'); ?>" data-setup="{}">
						<source src="/stream/video/<?php echo $file;?>/{time}/{token}/{i}" type='video/mp4'>
						<!--source src="MY_VIDEO.webm" type='video/webm'-->
						<p class="vjs-no-js">
						  To view this video please enable JavaScript, and consider upgrading to a web browser that
						  <a href="http://videojs.com/html5-video-support/" target="_blank">supports HTML5 video</a>
					...
					<iframe border="0" style="width: 100%; height: 400px;" src="{? echo PMTV4_URL; ?}/demo.php?video=video-{file}-{i}"></iframe>
					<?php endif; ?>
					
					<a class="enter-fullscreen btn btn-primary" href="#" onclick="$('#video{i} .vjs-fullscreen-control').click(); return false;">Xem toàn màn hình</a>
				  </div>
				  <?php endfor;?>
				</div>
				...
				function select_video(videoIndex) {
					...
					$('#video' + videoIndex).html('<iframe border="0" style="width: 100%; height: 400px;" src="{? echo PMTV4_URL; ?}/demo.php?video=video-{file}-'+videoIndex+'"></iframe>');
				}
				</script>
				<?php endif;?>
				<?php endif;?>
