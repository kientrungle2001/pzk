	...
	<?php echo pzk_theme_html_open_tag('container.header') ?>
		...
		<?php echo pzk_theme_html_open_tag('navbar') ?>
		  <?php echo pzk_theme_html_open_tag('navbar-nav') ?>
			...
			<?php endif;?>
			<li><a style="border-top: 5px solid #46b1b5;" href="<?php  echo PMTV4_URL; ?>/home/about#tab4" class="auto-font btn btn-danger"><span class="glyphicon glyphicon-gift"></span> NẠP THẺ </a></li>
