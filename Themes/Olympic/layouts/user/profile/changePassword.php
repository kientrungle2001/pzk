<div class="profile-change-password bottom20">
	<div class="edit-area">
		...
		<form  id="frmeditPass" method="post">
			...
			<div class="row">
				<div class="col-xs-4">
					<label for="epass_oldpass">{data.LBL_OLD_PASSWORD} (*):</label>
					<input type="password" 
			...
			<div class="row"> 
				<div class="col-xs-4" >
					<label for="epass_newpass">{data.LBL_NEW_PASSWORD} (*):</label>
					<input type="password" 
				...
				<div class="col-xs-4" >
					<label for="epass_cfrpass">{data.LBL_CONFIRM_PASSWORD} (*):</label>
					<input type="password" 
