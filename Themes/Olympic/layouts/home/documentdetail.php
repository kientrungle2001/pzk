<div class="container document">
	<h4 class="text-center top60 hidden-xs">Ngôn ngữ - quà tặng của trí tuệ</h4>
</div>
<script>
	$(function() {
	...
	<div class="row">
		<div class="col-md-2 col-xs-12">
			<ul class="nav nav-pills nav-stacked">
				<li class="active sharp text-center"><a href="#">Tài liệu Toán</a></li>
				<li><a href="#">Tài liệu 1</a></li>
				<li><a href="#">Tài liệu 2</a></li>
				<li><a href="#">Tài liệu 3</a></li>
				<li><a href="#">Tài liệu 4</a></li>
				<li><a href="#">Tài liệu 5</a></li>
				<li><a href="#">Tài liệu 6</a></li>
				<li><a href="#">Tài liệu 7</a></li>
				<li><a href="#">Tài liệu 8</a></li>
				<li><a href="#">Tài liệu 9</a></li>
			</ul>
		</div>
		<div class="col-md-8 col-xs-12 mglefft-12">
			<div class="btn-custom">
				<p class="t-weight text-center">Chọn môn học</p>
				<iframe src="/3rdparty/pdf.js/web/viewer.html?file=test.pdf" style="width:100%; height:600px; "></iframe>
			</div>
			<p class="text-center pd-20"><i class="fa fa-link"></i>Tải về <a href="">70-de-thi-hoc-ky-1-lop-3.pdf</a></p>
		</div>
