<?php 
	...
	if(count($dataUserAnswers) > 0){
		...
		//data questions
		$dataQuestions = _db()->select('id, request, name_vn, type, topic_id, type_id')
			->from('questions')
...
?>
<form role="form" name="update_book" action="<?php echo BASE_REQUEST . '/Admin_Book/updateHomework' ?>" method='post'>
<div class="panel panel-default">
	...
	<div class="col-xs-12">
		...
		<textarea class="item tinymce_input" name="note"><?=$dataShowUserBook['note'];?></textarea>
	</div>
