					    		...
					    		<div class="form-group top10">
					    			<div class="col-md-3  text-center">
								  	...
								  	<div class="col-md-2 col-sm-4 col-xs-6 control-group">
								  		<img class="img-responsive" onclick="return pzk_{data.id}.LoginFB()" alt="Đăng nhập bằng tài khoản facebook" src="<?php echo BASE_URL.'/Default/skin/nobel/test/media/facebook.png'; ?>" data-toggle="tooltip" data-placement="top" title="Đăng nhập bằng tài khoản Facebook">
								  	</div>
								  	<div class="col-md-2 col-sm-4 col-xs-6 control-group">
								  		<img class="img-responsive" onclick="return pzk_{data.id}.LoginGoogle()" src="<?php echo BASE_URL.'/Default/skin/nobel/test/media/google.png'; ?>" data-toggle="tooltip" data-placement="top" title="Đăng nhập bằng tài khoản Gmail">
								  	</div>
