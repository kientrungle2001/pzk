			    		...
			    		<div class="row">
			    			<form id="loginForm" class="login form-horizontal" onsubmit="return pzk_<?php echo @$data->id?>.login()" method="post">
				    			...
				    			<div class="col-md-2 text-left">
							  	...
							  	<div class="col-md-4 col-sm-4 col-xs-12 control-group top10">
							  	...
							  	<div class="col-md-2 col-sm-2 col-xs-12 top10 text-center">
					    		...
					    		<div class="form-group top10">
					    			<div class="col-md-3  text-center">
								  	...
								  	<div class="col-md-2 col-sm-4 col-xs-6 control-group">
								  		<img class="img-responsive" onclick="return pzk_<?php echo @$data->id?>.LoginFB()" alt="Đăng nhập bằng tài khoản facebook" src="<?php echo BASE_URL.'/Default/skin/nobel/test/media/facebook.png'; ?>" data-toggle="tooltip" data-placement="top" title="Đăng nhập bằng tài khoản Facebook">
								  	</div>
								  	<div class="col-md-2 col-sm-4 col-xs-6 control-group">
								  		<img class="img-responsive" onclick="return pzk_<?php echo @$data->id?>.LoginGoogle()" src="<?php echo BASE_URL.'/Default/skin/nobel/test/media/google.png'; ?>" data-toggle="tooltip" data-placement="top" title="Đăng nhập bằng tài khoản Gmail">
								  	</div>
			    		...
			    		<div class="row">
			    			<form id="registerForm" class="register form-horizontal top20" onsubmit="return pzk_<?php echo @$data->id?>.register()">
					    		<div class="form-group top10">
							    	...
							    	<div class="clearfix"></div>
							    	<div class="col-md-2 col-md-offset-2 top10 hidden-xs">
									...
									<div class="col-md-2 col-md-offset-2 top10 visible-xs text-center">
							    		<button type="submit" id="registerButton" onclick="return pzk_<?php echo @$data->id?>.set_birthday()" class="btn btn-primary sharp">Đăng ký</button>
							    	</div>
							  	</div>
					    	</form>
