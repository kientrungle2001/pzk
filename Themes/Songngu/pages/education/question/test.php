<Block  layout="education/question/test" id="showTest">
	...
	<Education.Question.Test table="tests" id="test" position="mid-content" layout="education/question/testcontent" />
</Block>