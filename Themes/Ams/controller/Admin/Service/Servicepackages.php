...
class PzkAdminServiceServicepackagesController extends PzkGridAdminController {
	public $addFields 	= 	'id, serviceName,serviceType,testDate, amount, software,site,contestId,categoryIds,duration,languages,contestIds';
	public $editFields 	= 	'id, serviceName,serviceType,testDate, amount,software,site,contestId,categoryIds,duration,languages,contestIds';
