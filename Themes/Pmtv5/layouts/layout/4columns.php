	...
	<div class="row">
		<div class="col-xs-12">			
			<div class="header bgcolor5-bold">
				<h2 class="text-left margin-0 padding-10 font-large border-bottom"><a href="/<?php echo @$root['alias']?>" class="font-large text-bold color7"><img src="/Themes/pmtv5/skin/media/luyentuvacau.png" style="height: 35px;" /> <?php echo @$root['name']?></a></h2>
			</div>
