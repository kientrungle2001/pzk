		...
		<div class="row columns-lecture">
			<div class="col-xs-12">
				...
				<div class="lecture-index">
					<h2 class="tab1 bgcolor4-bold hidden-xs"><a href="/<?php echo @$term1['alias']?>">Học kỳ 1</a></h2>
					<h2 class="tab2 bgcolor4-bold hidden-xs"><a href="/<?php echo @$term2['alias']?>">Học kỳ 2</a></h2>
