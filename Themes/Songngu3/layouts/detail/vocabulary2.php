...
<div class="item <?php if($level == 0 ){ echo "hidden"; }?> mg0 pd0">
	...
	<ul class="voca-menu item list-group">
		...
		<li class="list-group-item hasa"><a href="" class="getdata2" onclick="showdoc({item[id]},{item[trial]}); $('.fix_hover2').dropdown('toggle'); return false;" data-bind="disable: noResults()" data-check="<?php echo $check; ?>" data-cate="<?php echo $cate; ?>"><?php if(pzk_user_special()): ?>#{item[id]} - <?php endif; ?>
		...
		?>
		{each $vocabulary as $item}
		<li class="list-group-item hasa"><a href="" onclick="showdoc({item[id]},{item[trial]}); $('.fix_hover2').dropdown('toggle'); return false;" data-bind="disable: noResults()" data-check="<?php echo $check; ?>" data-cate="<?php echo $cate; ?>"><?php if(pzk_user_special()): ?>#{item[id]} - <?php endif; ?>
...
<script>
	...
	?>
		$(function() {
			showdoc({documentId}, {document[trial]});
		});
