...
<div style="width: 320px; height: 270px;" class="alert alerttb newbox alert-dismissible hidden-xs">
  ...
  <div class="w100p">
		...
		<H4 style="color: red;"><a href="http://fulllooksongngu.com/danh-gia-nang-luc-vao-lop-6">NHỮNG THÔNG TIN CẦN BIẾT VỀ HÌNH THỨC KIỂM TRA, ĐÁNH GIÁ NĂNG LỰC VÀO LỚP 6</a></H4>
			...
			<div class="row col-xs-12 col-md-6 col-md-offset-1 info2 mg-top">
				...
				<div class="col-xs-12 col-md-4">
					...
					<ul class="text-left">
						...
						<li><a target="_blank" rel="nofollow"  href="http://www.dailymotion.com/video/x6aufhz"><?php echo $language['ontv'];?></a></li>
...
<?php endif; ?>
<?php endif; ?>
<?php if(pzk_request()->get('softwareId') == 1 && pzk_request()->get('siteId') == 2 ): ?>
