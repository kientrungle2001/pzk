...
<?php 
	$tab6 = pzk_request()->getTab6();
	$tab8 = pzk_request()->getTab8();
?>
...
<div class="container text-justify">
	<div class="row">
		...
		<ul class="nav nav-tabs " style="font-weight: bold;">
			...
			<li class="<?php if(!$tab8){ echo "active"; } ?>"><a data-toggle="pill" href="#videoinfo"  class="btn-info">Video giới thiệu</a></li>
			<li ><a data-toggle="pill" href="#visao"  class="btn-info">Vì sao cần dùng Full Look</a></li>
			...
			<li><a data-toggle="pill" href="#chinhsachhoc"  class="btn-info">Chính sách học bổng</a></li>
		...
		<div class="tab-content tab-contentct">
			...
			<div id="videoinfo" class="tab-pane fade bgcolor <?php if(!$tab8){ echo "in active"; }else{ echo "."; }?>">
				<div class="text-center" style="padding: 15px;">
					<h3 class="text-center">Full Look – Phần mềm đánh giá năng lực vinh dự được Bộ Giáo dục & Đào tạo trao tặng giải thưởng:<h3/>
					<h3 class="text-center red">CÔNG TRÌNH SÁNG KIẾN TIÊU BIỂU NHẤT NĂM 2017<h3/><br/>
			...
			<img src="/Themes/Phanlop/skin/media/tab3.png" class="img-responsive hidden-xs" />
			<img src="/Themes/Phanlop/skin/media/tab3mb.png" class="img-responsive visible-xs"/>
			</div>
		  
			<div id="cautruc" class="tab-pane fade bgcolor">
			<img src="/Themes/Phanlop/skin/media/tab4.png" class="img-responsive hidden-xs" />
			<img src="/Themes/Phanlop/skin/media/tab4mb.png" class="img-responsive visible-xs"/>
			</div>
			<div id="tienich" class="tab-pane fade bgcolor">
			<img src="/Themes/Phanlop/skin/media/tab5.png" class="img-responsive hidden-xs"  />
			<img src="/Themes/Phanlop/skin/media/tab5mb.png" class="img-responsive visible-xs"/>
			</div>
			<div id="visao" class="tab-pane fade bgcolor ">
				<img src="/Themes/Phanlop/skin/media/tab722.png" class="img-responsive item hidden-xs"  />
				<img src="/Themes/Phanlop/skin/media/tab7mb.png" class="img-responsive visible-xs"/>
			</div>
			<div id="cacbuoc" class="tab-pane fade bgcolor">
				<img src="/Themes/Phanlop/skin/media/tab6.png" class="img-responsive hidden-xs"  />
				<img src="/Themes/Phanlop/skin/media/tab6mb.png" class="img-responsive visible-xs"/>
			</div>
			<div id="chinhsachhoc" class="tab-pane fade bgcolor">
				<img class="item" src="/Themes/Songngu3/skin/images/hocbong.png" alt="chinh sach hoc bong"/>
			</div>
			...
			<div id="buynow" class="tab-pane fade bgcolor <?php if($tab8){ echo "in active"; } ?>">
				...
				<div class="item">
					...
					<img src="/Themes/Phanlop/skin/media/tab1mb.png" class="img-responsive visible-xs item" alt="" usemap="#Mapmb" />
