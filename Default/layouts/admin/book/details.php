<?php 
	...
	if(count($dataUserAnswers) > 0){
		...
		//data questions
		$dataQuestions = _db()->select('id, request, name, type, topic_id, type_id')
			->from('questions')
...
<div class="panel panel-default">
  	...
  	<div class="panel-heading col-xs-12">
  		...
  		<!--div class="col-xs-2">Bài tập số :<b> <?php //$dataShowUserBook['exercise_number']?> </b></div-->
  		<!--div class="col-xs-2">Dạng bài tập : <b><?php //$dataShowUserBook['category_name']['name'];?></b></div-->
  		<!--div class="col-xs-2">Học sinh : <b><?php //$dataShowUserBook['student_name']['username'];?></b></div-->
  		<div class="col-xs-2">Ngày làm bài : <b><?=$dataShowUserBook['start_time']?></b></div>
  		<!--div class="col-xs-2"><?php // if($dataShowUserBook['teacher_name'] != null ):?> Giáo viên chấm : <b> <?php //$dataShowUserBook['teacher_name']['name']?></b><?php //endif;?></div-->
