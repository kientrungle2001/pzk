...
<div class="col-xs-3 text-center">
	...
	<h4>{item[controller_name]}/{item[action_name]}</h4>
	<div class="link-icons">
		<a href="/Admin_Site_Controllerlayout/design/{item[id]}">Thiết kế trang</a> | <a href="/Admin_Site_Controllerlayout/del/{item[id]}&backHref=/admin_directory_theme/detail/{data.getThemeId()}">Xóa</a>
	</div>
</div>
<!--/each-->
<div class="col-xs-3 text-center">
