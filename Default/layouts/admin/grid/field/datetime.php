...
<span class="inline-edit" id="inline-item-<?php  echo $data->getIndex() ?>-<?php  echo $data->getItemId() ?>">
	<span class="inline-text" ondblclick="pzk_list.showInlineEdit('<?php  echo $data->getIndex() ?>', <?php  echo $data->getItemId() ?>); return false;"><?php echo $dateFormated ?></span>
	<span class="inline-input" style="display: none;">
		<input class="inline-input-field" type="text" name="<?php  echo $data->getIndex() ?>" value="<?php  echo date('m/d/Y H:i', strtotime($data->getValue())) ?>" 
...
<script type="text/javascript">
	...
	$('#inline-item-<?php  echo $data->getIndex() ?>-<?php  echo $data->getItemId() ?> .inline-input-field').datepicker({defaultDate: new Date('<?php  echo $data->getValue() ?>') });
	<?php } else { ?>
	$('#inline-item-<?php  echo $data->getIndex() ?>-<?php  echo $data->getItemId() ?> .inline-input-field').datetimepicker({defaultDate: new Date(<?php  echo strtotime($data->getValue())?> * 1000) });
	<?php } ?>
</script>
