<div style="margin-bottom: 10px; position: relative;" class="well well-sm item">
	...
	<div id="form-<?php echo $data->get('id')?>">
		...
		<div class="item">
			<form role="form" onsubmit="pzk_list.updateMutiSelect(this, '<?php echo $data->get('index')?>', '<?php echo $data->get('type')?>'); return false;">
			<div class="form-group">
			<label for="<?php echo @$item['index']?>"><?php echo $data->get('nameField')?></label><br />
			<select class="form-control" id="<?php echo $data->get('index')?>" name="<?php echo $data->get('index')?>[]" multiple="multiple" size="10">
