...
<?php if($inline):?>
	...
	<div class="row">
		<?php if(${'nocompact'}): ?><label class="control-label col-md-3" for="<?php  echo $data->getIndex()?><?php echo $rand ?>"><?php  echo $data->getLabel()?></label><?php endif; ?><div class="col-md-9"><select
