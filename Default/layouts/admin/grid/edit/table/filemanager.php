...
<input type="hidden" id="filemanagerreturningvalue" onchange="selected_filemanager_input.val(this.value); selected_filemanager_input.change();" placeholder="<?php  echo $data->get('label')?>"/>
...
<button type="button" class="btn btn-primary" data-toggle="modal"
				data-target="#m<?php  echo $data->get('index')?><?php echo $rand ?>" onclick="selected_filemanager_input = $(this).prev();">Select</button>