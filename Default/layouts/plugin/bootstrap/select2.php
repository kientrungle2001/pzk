...
?>
<link rel="stylesheet" type="text/css" href="<?php echo $select2CssFile ?>"/>
<link rel="stylesheet" type="text/css" href="<?php echo $select2bootstrapCssFile ?>"/>
<script src="<?php echo $select2JsFile ?>" type="text/javascript"></script>