...
<div class="panel-body" style="min-height: 350px">
	<div class="col-xs-6">
    	...
    	<p><b>Đáp án sai  :</b> <?=$content['extra'];?></p>
		...
		<div id="dapan_content_<?=$items['id']?>" style="display: none;">
			...
			foreach($itemsAnswers as $key => $answers){
				if($answers['status'] == 1){
					$answersTrue = $answers['content'];
					$answersFull = $answers['content_full'];
					$answersRecommend = $answers['recommend'];
				}
				if($answers['status'] == 0){
					$answersFalse = $answers['content'];
				}
			}
			
			echo "  <b>Đáp án sai </b> : " .$answersFalse." <br/>";
			echo "  <b>Đáp án đúng </b> : " .$answersTrue." <br/>"; 
			echo "  <b>Giải thích </b> : " .$answersRecommend." <br/>";
			?>
		</div>
	</div>
	<div class="col-xs-6">
