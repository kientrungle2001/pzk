<?php
class PzkAdminSubscriberController extends PzkGridAdminController {
    public $title = 'Quản trị người đăng ký nhận thư báo';
	public $addFields = 'email, registered, status';
    public $editFields = 'email, registered, status';
    public $table = 'newsletter_subscriber';
    public $filterStatus = true;
	public $logable = true;
	public $logFields = 'email, registered, status';
    public $sortFields = array(
        'id asc' => 'ID tăng',
        'id desc' => 'ID giảm',
        'email asc' => 'Email tăng',
        'email desc' => 'Email giảm',
    	'registered asc' => 'Ngày đăng ký tăng',
