...
class PzkAdminPaymentHistorypaymentController extends PzkGridAdminController {
	public $addFields = ' username, paymentType,bank,transactioncode,billcode, amount, paymentStatus,paymentDate,expiredDate, status, software,buySoftware, serviceType,site, contestId, serviceId, categoryIds, class, categoryIds,languages';
	public $editFields = ' username, paymentType,bank,transactioncode,billcode, amount, paymentStatus,paymentDate,expiredDate, status,software,buySoftware, serviceType,site, contestId, serviceId, categoryIds, class , categoryIds,languages';
