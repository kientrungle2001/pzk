...
class PzkAdminReportPaymentController extends PzkReportController
{
	...
	public $sortFields = array(
		...
		'`history_payment`.`created` asc' 	=> 'Ngày tạo tăng',
		'`history_payment`.`created` desc' 	=> 'Ngày tạo giảm',
		'`history_payment`.`paymentDate` asc' 	=> 'Ngày mua tăng',
		'`history_payment`.`paymentDate` desc' 	=> 'Ngày mua giảm',
	);
