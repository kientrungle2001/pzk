...
class PzkAdminSiteLayoutpositionController extends PzkGridAdminController {
    public $addFields = 'layout, theme, position, software, sharedSoftwares, global, status';
    public $editFields = 'layout, theme, position, software, sharedSoftwares, global, status';
