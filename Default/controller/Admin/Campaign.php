<?php
class PzkAdminCampaignController extends PzkGridAdminController {
	...
	public $addFields = 'name, options, content, created, startDate, endDate, expectedRegister, expectedBuyer, expectedApproach, expectedRevenue, cost, status';
	public $editFields = 'name, options, content, created, startDate, endDate, expectedRegister, expectedBuyer, expectedApproach, expectedRevenue, cost, status';	
