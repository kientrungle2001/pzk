...
<form role="form" method="post" action="<?php echo BASE_REQUEST . '/admin_' ?><?php echo @$controller->module?>/edit_tnPost">
  	...
  	<div id="content">
  		<div class="col-xs-6 margin-top-10">
		    <div class="input-group">
		      	...
		      	<textarea class="form-control content_value tinymce_input" name="content[]"  aria-required="true" aria-invalid="false"></textarea>
		    </div>
		</div>
  	</div>
	...
	<div class="form-group col-xs-12">
  		...
  		<div id="content">
	  		...
	  		<div class="col-xs-6 margin-top-10 element-input">
			    <div class="input-group">
			      	...
			      	<textarea class="form-control col-xs-6 content_value tinymce_input" name="content[]"  aria-required="true" aria-invalid="false"><?=$value['content']?></textarea>
					<textarea class="form-control col-xs-6 content_value tinymce_input" name="content_vn[]"  aria-required="true" aria-invalid="false"><?=$value['content_vn']?></textarea>
			    </div>
  	...
  	<div class="margin-top-20">
	  	<div class="col-xs-4">
			...
			<a class="btn btn-default" href="<?php echo BASE_REQUEST . '/admin_' ?><?php  echo pzk_request()->getController(); ?>/<?php echo @$item['questionId']?>">Quay Lại</a>
		</div>
	</div>
</form>
...
<script>
	...
	function addRow(i) {
	    ...
	    div.innerHTML = '<div class="input-group">\
	    					...
	    					<textarea class="form-control content_value tinymce_input" name="content[]"  aria-required="true" aria-invalid="false"></textarea>\
							<textarea class="form-control content_value tinymce_input" name="content_vn[]"  aria-required="true" aria-invalid="false"></textarea>\
	        			</div>\
	        			<div class="remove-input"><a href="javascript:void(0)" class="color_delete" title="Xóa"><span class="glyphicon glyphicon-remove-circle"></span></a></div>';
