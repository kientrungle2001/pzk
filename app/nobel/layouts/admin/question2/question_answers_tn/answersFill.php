...
<form role="form" method="post" action="{url /admin_}{controller.module}/edit_tn20Post">
 	<input type="hidden" name="id" value="{item[id]}" />
  	...
  	<div class="row title-ptnn"><div class="col-xs-12 margin-top-10">Đáp án hoàn chỉnh  : </div></div>
	...
	<div class="row title-ptnn"><div class="col-xs-12 margin-top-10">Giải thích  : </div></div>
  	...
  	<div class="margin-top-20">
	  	<div class="col-xs-4">
			...
			<a class="btn btn-default" href="{url /admin_}{controller.module}/{item[questionId]}">Quay Lại</a>
		</div>
	</div>
</form>
