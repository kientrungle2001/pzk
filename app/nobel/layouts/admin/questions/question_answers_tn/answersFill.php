...
<form role="form" method="post" action="<?php echo BASE_REQUEST . '/Admin_Question2/edit_tn20Post' ?>">
	...
	<div class="row title-ptnn"><div class="col-xs-12 margin-top-10">Giải thích  : </div></div>
  	...
  	<div class="margin-top-20">
	  	<div class="col-xs-4">
			...
			<a class="btn btn-default" href="<?php echo BASE_REQUEST . '/Admin_Question2' ?>/<?php echo @$item['questionId']?>">Quay Lại</a>
		</div>
	</div>
</form>
