  ...
  <div class="bank_area">
    ...
    <span class="pm_change_detail">(Nội dung chuyển khoản:<?php  echo pzk_config('bank_content1')?> )</span>
    </div>
    ...
    <table class="table table-hover" >
        ...
        <tr>
            <th>
                <div class="imgbank"><img src="/default/skin/test/media/bank/Agribank.jpg" width="136" height="75" alt=" <?php  echo pzk_config('bank_name1')?>"></div>
            </th>
            <th>
                <br>
        ...
        <tr>
            <th>
                <div class="imgbank"><img src="/default/skin/test/media/bank/Vietcombank.jpg" width="136" height="75" alt=" <?php  echo pzk_config('bank_name1')?>"></div>
            </th>
            <th>
                <br>
                <span class="">Số tài khoản: </span>
        ...
        <tr>
            <th>
                <div class="imgbank"><img src="/default/skin/test/media/bank/MBbanks.jpg" width="136" height="75" alt=" <?php  echo pzk_config('bank_name1')?>"></div>
            </th>
            <th>
                <br>
                <span class="">Số tài khoản: </span>
        ...
        <tr>
            <th>
                <div class="imgbank"><img src="/default/skin/test/media/bank/BIDV.jpg" width="136" height="75" alt=" <?php  echo pzk_config('bank_name1')?>"></div>
            </th>
            <th>
                <br>
                <span class="">Số tài khoản: </span>
        ...
        <tr>
            <th>
                <div class="imgbank"><img src="/default/skin/test/media/bank/vietinbank.jpg" width="136" height="75" alt=" <?php  echo pzk_config('bank_name1')?>"></div>
            </th>
            <th>
                <br>
                <span class="">Số tài khoản: </span>
        ...
        <tr>
            <th>
                <div class="imgbank"><img src="/default/skin/test/media/bank/DongAbank.jpg" width="136" height="75" alt=" <?php  echo pzk_config('bank_name1')?>"></div>
            </th>
            <th>
                <br>
                <span class="">Số tài khoản: </span>
                <span class="pm_change_detail"><?php  echo pzk_config('bank_number6')?></span>
                <br>
                <span class="">Chủ tài khoản: </span>
                <span class="pm_change_detail"><?php  echo pzk_config('bank_user6')?></span>
                <br>
                <span class="">Ngân hàng: </span>
                <span class="pm_change_detail"><?php  echo pzk_config('bank_name6')?></span>
                <br>
                <span class="">Chi nhánh: </span>
                <span class="pm_change_detail"><?php  echo pzk_config('bank_place6')?></span>
                <br>
            </th>
        </tr>
    </table>
  ...
  <div class="pm_change">
    ...
    <span class="pm_change_detail"><?php  echo pzk_config('note1')?> </span> <br>
    <span class="" style="color: green;">2. </span>
    <span class="pm_change_detail"><?php  echo pzk_config('note2')?> </span> <br>
    <span class="" style="color: green;">3. </span>
    <span class="pm_change_detail"><?php  echo pzk_config('note3')?> </span>
  </div>
