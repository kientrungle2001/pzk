   ...
   <div class="ensupport">   		
      ...
      <div style="display:none;">
            <div id="demo2_tip">
                ...
                <br>
                <span class="img_tooltip"><a title="Hỗ trợ Skype " href="skype:{? echo pzk_config('vn_skype')?}?chat"><img src="<?php echo BASE_URL.'/default/skin/test/media/icon-skype.gif'; ?>" alt=""></a>
                <a href="ymsgr:sendIM?{? echo pzk_config('vn_yahoo')?}" title="Hỗ trợ Yahoo"><img src="<?php echo BASE_URL.'/default/skin/test/media/icon-ym.gif'; ?>" alt=""> </a> 
                </span>
