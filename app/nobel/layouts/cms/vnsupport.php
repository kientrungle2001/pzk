...
<link href="<?php echo BASE_URL.'/default/skin/test/css/tooltip.css'; ?>" rel="stylesheet" type="text/css" />
   ...
   <div class="ensupport">   		
      ...
      <div style="display:none;">
            <div id="demo2_tip">
				...
				<span class="img_tooltip" ><img src="<?php echo BASE_URL.'/default/skin/test/media/icon-mobile.gif'; ?>" alt=""></span>
                <span class="txt_tooltip">Hotline 2: <?php  echo pzk_config('vn_hotline')?></span><br>
                <span class="img_tooltip" ><img src="<?php echo BASE_URL.'/default/skin/test/media/Email.gif'; ?>" alt=""></span>
                <span class="txt_tooltip">Email: <?php  echo pzk_config('vn_email')?></span>
                <br>
                <span class="img_tooltip"><a title="Hỗ trợ Skype " href="skype:<?php  echo pzk_config('vn_skype')?>?chat"><img src="<?php echo BASE_URL.'/default/skin/test/media/icon-skype.gif'; ?>" alt=""></a>
                <a href="ymsgr:sendIM?<?php  echo pzk_config('vn_yahoo')?>" title="Hỗ trợ Yahoo"><img src="<?php echo BASE_URL.'/default/skin/test/media/icon-ym.gif'; ?>" alt=""> </a> 
                </span>
        ...
        <a style="position: relative;" href="<?=BASE_REQUEST?>/payment/bank2/2"><button type="submit" class="rg_button4 showpay">Mua sản phẩm</button></a>
   			<div style="display: none;" id="showtt">Sản phẩm sắp ra mắt trong thời gian tới</div>
