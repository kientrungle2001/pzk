    ...
    <script>
		...
		Game.prototype = {
			...
			checkEnd: function() {
				...
				if(score == 10 ) {
					...
					var score = board.score;
					$('input#dragScore').val(score);
					
					var txtScore = new createjs.Text("Qua Bài", "bold 16px Lato", "orange");
					...
					var txtScore = new createjs.Text("Làm sai quá số lần cho phép", "bold 16px Lato", "orange");
					txtScore.textAlign = "center";
					txtScore.x = 200;
					txtScore.y = 8;
					board.stage.removeChild(board.txtMes);
			...
			endGame: function() {
				...
				var score = board.score;
				$('input#dragScore').val(score);
				var txtScore = new createjs.Text("Đã nộp bài", "bold 16px Lato", "orange");
				txtScore.textAlign = "center";
				txtScore.x = 200;
				txtScore.y = 8;
				board.stage.removeChild(board.txtMes);
		...
		Board.prototype = {
			...
			displayScore: function () {
				this.txtScore = new createjs.Text("Điểm: 0", "bold 16px Lato", "orange");
				...
				this.shapes[i].on("pressup", function (evt) {
					...
					if(objtopic) {
						if (that.check(this, objtopic)) {
							...
							var txtScore = new createjs.Text("Điểm: "+score.score, "bold 16px Lato", "orange");
							txtScore.textAlign = "center";
							txtScore.x = 40;
							txtScore.y = 8;
...
<div class='mgb15'>
	...
	<input type='hidden' name = 'dragScore' id='dragScore'/>
</div>
<?php } else { ?>
Chưa có dữ liệu
<?php } ?>