...
<style type="text/css">
	.cell {
		...
		height: 100px;
		text-align: center;
		border: 2px solid #c17350;
		margin: 5px;
		background: url('/default/skin/nobel/olympic/themes/olympic/image/bg_boxclick.png') repeat-x;
	}
	.cell .word {
		padding-top: 40px;
		color: #e6562d;
...
Game.prototype = {
	...
	saveData: function() {
		...
		var time = Factory.getTiming().value;
...
Cell.prototype = {
	...
	select: function() {
		$('.cell-'+this.x+'-'+this.y).css('border', '2px solid blue');
	},
	deselect: function() {
		$('.cell-'+this.x+'-'+this.y).css('border', '2px solid #c17350');
	},
	match: function(c) {
...
<div id="game">
	...
	<div id='cate_other'>
		<a href="#">Trac nghiem</a>
		<a href="#">Dien tu</a>
		<a>Keo tu vao chu de</a>
		<a>Chon tu dong nghia</a>
