...
<form role="form" method="post" action="<?php echo BASE_REQUEST . '/admin_questions/edit_tn2Post' ?>">
	...
	<div class="form-group col-xs-12">
		<textarea id="content_full" class="form-control tinymce_input" rows="2" name="content_full" aria-required="true" aria-invalid="false"></textarea>
    </div>
	...
	<div class="form-group col-xs-12">
  	...
  	<?php else:?>
  		<div id="content">
	  		...
	  		<div class="col-xs-12 margin-top-10 element-input">
			    <div class="input-group">
  		...
  		<div class="row title-ptnn"><div class="col-xs-12 margin-top-10">Câu hoàn chỉnh  : </div></div>
		<div class="form-group col-xs-12">
			<textarea id="content_full" class="form-control tinymce_input" rows="2" name="content_full" aria-required="true" aria-invalid="false"><?=$itemAnswers[0]['content_full']?></textarea>
	    </div>
...
<script>
	...
	function addRow(i) {
	    ...
	    div.className = 'col-xs-12 margin-top-10 element-input';
...
<style>
	...
	.remove-input{position: absolute;top:0;right:0px;padding-top:6px;}
</style>