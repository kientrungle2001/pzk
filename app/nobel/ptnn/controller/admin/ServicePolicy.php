...
class PzkAdminServicePolicyController extends PzkGridAdminController {
    ...
    public $selectFields = 'service_policy.*,service_packages.serviceName as serviceName, service_packages.serviceType as serviceType, campaign.campaignName as campaignName,creator.name as creatorName, modifier.name as modifiedName';
