...
class PzkAdminConfigController extends PzkConfigAdminController {
    public $menuLinks = array(
		...
		array(
           ...
           'href' => '/admin_config/edit?config=emailTransaction'
        ),
        array(
                'name' => 'Ngân Lượng',
	...
	public $siteFields = array('site_name', 'site_banner', 'site_company', 'site_slogan', 'site_copyright', 'site_google_analytics_code',
	'site_fb_page', 'site_google_page', 'site_twitter_page',
	'site_pinterest_page', 'site_offline');
    public $siteFieldSettings = array(
        ...
        array(
            'index' => 'site_copyright',
            'type' => 'text',
            'label' => 'Bản quyền'
        ),
		array(
            'index' => 'site_google_analytics_code',
            'type' => 'text',
		...
		array(
            'index' => 'site_google_page',
            'type' => 'text',
            'label' => 'Google Page'
        ),
		array(
            'index' => 'site_twitter_page',
            'type' => 'text',
            'label' => 'Twitter Page'
        ),
		array(
            'index' => 'site_pinterest_page',
            'type' => 'text',
        ...
        array(
            'index' => 'site_offline',
            'type' => 'status',
            'label' => 'Chế độ bảo trì offline'
        )
    );
	
    public $databaseFields = array('db_host', 'db_user', 'db_password', 'db_database');
    ...
    public $emailFields = array('email_host', 'email_user', 'email_password', 'email_port');
	...
	public $emailTransactionFields = array('email_transaction_register', 'email_transaction_deposit', 'email_transaction_ordercard', 'email_transaction_payservice', 'email_transaction_mark', 'email_transaction_trophies');
    public $emailTransactionFieldSettings = array(
    		array(
    				'index' => 'email_transaction_register',
    				'type' => 'select',
    				'label' => 'Đăng ký thành công',
					'table'	=> 'newsletter_newsletter',
					'condition'	=> array('code', 'register'),
					'show_name'	=> 'subject',
					'show_value'	=> 'id'
    		),
    		array(
    				'index' => 'email_transaction_deposit',
    				'type' => 'select',
    				'label' => 'Nạp tiền thành công',
					'table'	=> 'newsletter_newsletter',
					'condition'	=> array('code', 'deposit'),
					'show_name'	=> 'subject',
					'show_value'	=> 'id'
    		),
    		array(
    				'index' => 'email_transaction_ordercard',
    				'type' => 'select',
    				'label' => 'Mua thẻ thành công',
					'table'	=> 'newsletter_newsletter',
					'condition'	=> array('code', 'ordercard'),
					'show_name'	=> 'subject',
					'show_value'	=> 'id'
    		),
    		array(
    				'index' => 'email_transaction_payservice',
    				'type' => 'select',
    				'label' => 'Mua dịch vụ thành công',
					'table'	=> 'newsletter_newsletter',
					'condition'	=> array('code', 'payservice'),
					'show_name'	=> 'subject',
					'show_value'	=> 'id'
    		),
			array(
    				'index' => 'email_transaction_mark',
    				'type' => 'select',
    				'label' => 'Đã có bài chấm',
					'table'	=> 'newsletter_newsletter',
					'condition'	=> array('code', 'mark'),
					'show_name'	=> 'subject',
					'show_value'	=> 'id'
    		),
			array(
    				'index' => 'email_transaction_trophies',
    				'type' => 'select',
    				'label' => 'Tăng hạng thành viên',
					'table'	=> 'newsletter_newsletter',
					'condition'	=> array('code', 'trophies'),
					'show_name'	=> 'subject',
					'show_value'	=> 'id'
    		)
    );
	
    public $nganluongFields = array('nganluong_merchant','merchant_id','merchant_pass',);
    ...
    public $bankTransferFields = array('bank_number1','bank_user1','bank_name1','bank_place1','bank_content1','bank_number2','bank_user2','bank_name2','bank_place2','bank_content2','bank_number3','bank_user3','bank_name3','bank_place3','bank_content3','bank_number4','bank_user4','bank_name4','bank_place4','bank_content4','bank_number5','bank_user5','bank_name5','bank_place5','bank_content5','bank_number6','bank_user6','bank_name6','bank_place6','bank_content6','note1','note2','note3');
    ...
    public $officeFields = array('name_office','address_office','phone_office','note_office');
    ...
    public $supportFields = array('hotline','email','yahoo','skype','vn_hotline','vn_email','vn_yahoo','vn_skype', 'support_en_link', 'support_vn_link');
    ...
    public $registerActiveFields = array('register_active');
    ...
    //config time cache
    public $cacheFields = array('time_cache_web', 'time_cache_session');
    ...
    public $loginFbFields = array('AppID','AppSecret');
    ...
    public $loginGFields = array('client_id','client_secret','developer_key','redirect_url');
