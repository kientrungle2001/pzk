...
<form role="form" method="post" action="{url /admin_questions/edit_tn20Post}">
 	<input type="hidden" name="id" value="{item[id]}" />
  	...
  	<div class="form-group col-xs-12 margin-top-10">
		<textarea name="content" class="form-control tinymce_input" aria-required="true" aria-invalid="false"> <?php if(isset($itemAnswers)) echo $itemAnswers[0]['content'];?></textarea>
	</div>
