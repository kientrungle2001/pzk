...
if($getGameType && $getTopic) {
    ...
    if($dataWord){
        ...
        <script id="editable">
            ...
            RainWord = {
                ...
                init: function(dataword, dataTrue) {
                    ...
                    //draw sky
                    //this.skys();
                    this.bitmap = new createjs.Bitmap(BASE_URL+"/default/skin/nobel/game/images/play1.png");
                    this.bitmap.x = 0;
                    this.bitmap.y = 0;
                    ...
                    this.buildStart();
                    var data = {
                        images: [BASE_URL+"/default/skin/nobel/game/art/spritesheet_sparkle.png"],
                ...
                buildStart: function() {
                    ...
                    var label = new createjs.Text("Start", "bold 50px Arial", "#305958");
                    label.name = "label";
                    ...
                    this.button.addEventListener("click", function(event) {
                        ...
                        that.bitmap = new createjs.Bitmap(BASE_URL+"/default/skin/nobel/game/images/background_"+that.rand+".png");
                        that.bitmap.x = 0;
                        that.bitmap.y = 35;
                ...
                rainWord: function(dataword){
                    ...
                    for(i = 0; i < dataword.length; i++) {
                        ...
                        var txt = new TextLink(word, "bold 18px Arial", color, "orange");
                        txt.cursor = 'pointer';
                        var j = i +1;
                        if(j == 6) {
                            j = 1;
                        ...
                        success: function(data) {
                            if(data) {
                               ...
                               if(that.wordDel.length > 0 ) {
                                ...
                                var bitmap = new createjs.Bitmap(BASE_URL+"/default/skin/nobel/game/images/background_"+that.rand+".png");
                                bitmap.x = 0;
                                bitmap.y = 0;
        ...
        <div class="item" >
            ...
            <!-- Large modal -->
            <button id="showGame"  type="button" class="btn btn-primary" data-toggle="modal" data-target=".showGame">Show game</button>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="gridSystemModalLabel">Show game</h4>
                        </div>
                        <div class="modal-body">
                            <div class="alert alert-success" >
                                <b id="showWord" style="color: black;" >Words click true: <span style="color:red;" id="clickTrue"></span></b><br>
                                <b id="showWordFalse" style="color: black;" class="hide">Word click false: <span style="color:red;" id="clickFlase"></span> </b> <br>
                                <b id="showWordTrue" style="color: black;" class="hide">True word isn't click: <span style="color:red;" id="wordDel"></span></b>
                            </div>
                        </div>
                    </div>
                </div>
