...
<div class="step" >
  		...
  		<div class="col-xs-10 margin-top-10" style="position:relative; margin-top: 20px; " >
			<div class="input-group" >
			    <input type="text" style="width: 700px;" name="rewritesentence[<?=$i;?>][]" class="input_user_test form-control content_value"/>
			</div>
...
<script>
	    ...
	    div.className = 'col-xs-10  element-input';
		
	    div.innerHTML = '<div class="input-group" style="margin-bottom: 10px;" >\
	    					<input type="text" style="width: 700px;"  name="rewritesentence['+key+'][]" class="input_user_test form-control content_value"/>\
	        			</div>\
