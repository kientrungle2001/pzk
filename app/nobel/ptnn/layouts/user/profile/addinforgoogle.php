...
<div  class="addinfor"> 
                ...
                <div class="message_note" style="padding-top:10px; padding-bottom: 10px;">
                    ...
                    Sau khi bổ xung thông tin cá nhân bạn có thể sử dụng tên đăng nhập và mật khẩu này để đăng nhập trực tiếp vào NextNobels
                </div>
                <div class="clear"></div>    
                   
                    <form id="formAddinforG" class="register form-horizontal margin-top-20" method="post" onsubmit="pzk_<?php echo @$data->id?>.frmAddinforG(); return false; ">
                            <div class="form-group margin-top-10">
                                ...
                                <div class="col-xs-4 col-xs-offset-2 margin-top-10" style="margin-left:0px !important;">
                                    ...
                                    <input type="password" class="form-control" style="width: 317px;" id="addpassword" name="addpassword" placeholder="Mật khẩu" data-toggle="tooltip" data-placement="top" title="Mật khẩu phải có ít nhất 6 ký tự và không chứa khoảng trắng"/>
                                </div>
                                ...
                                <div class="col-xs-2 margin-top-10">
                                    ...
                                    <input type="text" class="form-control" id="addphone" style="width: 152px;" name="addphone" placeholder="Điện thoại" data-toggle="tooltip" data-placement="top" title="Điện thoại phải là số">
                                </div>
                                <div class="col-xs-2 margin-top-10" style="margin-left: 8px;">
                                    <label for="sex">Giới tính</label>
                                    <select  class="form-control" id="addsex" style="width: 116px;" name="addsex" data-toggle="tooltip" data-placement="top" title="Lựa chọn giới tính">
                                ...
                                <div id="mass_addinforG" class="col-xs-8 margin-top-10">
