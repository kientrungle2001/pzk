   ...
   //var datetime= dateFormat(new Date(), "mm-dd-yy h:MM:ss");
    ...
    $.ajax({
      ...
      success: function(result){
       $('#end_note_comment').append('<div class="user_note_comment"><div class="pfr_avatar_wall"><img src="'+avatar1+'" alt="" width="60" height="60"></div><div class="prf_titlenote" style="width:30%; height: auto; float:left;"><a href="/profile/user?member='+userId+'">'+userComment+'</a><br><span>'+datetime+'</span></div><div class="prf_titlenote" style="width:30%; height: auto; float:left;">'+comment_note+'</div><div class="prf_titlenote"></div></div>');
