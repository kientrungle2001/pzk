...
<div id="div_view_write_wall">
    ...
    <div class="clearfix">
      ...
      <input type="button" style="width:50px;float:left;color:black; margin-bottom: 10px;" onclick="pzk_<?php echo @$data->id?>.viewWall('<?php echo $avatar1 ?>','<?php echo $usercommId ?>','<?php echo $usercomm ?>','<?php echo $member ?>','<?php echo $datetime ?>');" class="pne_st1_r_file_bt" name="send" value="Gửi">
    ...
    <?php foreach($pages as $page): ?>
     <a href="#" onclick="pzk_<?php echo @$data->id?>.loadpage(<?php echo $page ?>, <?php echo $member ?>)" ><?php echo $page ?></a>
    <?php endforeach; ?>
    </div>
  </div>