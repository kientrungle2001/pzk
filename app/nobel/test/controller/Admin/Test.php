...
class PzkAdminTestController extends PzkGridAdminController {
    ...
    public $addFields = 'name, name_vn, name_sn, testMark, score, classes, categoryIds, content, trytest, time, quantity, status, practice, createdId, created, modifiedId, modified, software, isSort, parent, compability, homework, week, month, semester, teacherIds, subjectId, startDate, endDate, resultDate';
    ...
    public $editFields = 'name, name_en, name_sn, score, testMark, classes, categoryIds, content, trytest, time, status, quantity, practice, createdId, created, modifiedId, modified, software, isSort, parent, compability, homework, subjectId, week, month, semester, teacherIds, startDate, endDate, resultDate';
