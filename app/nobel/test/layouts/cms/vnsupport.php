   ...
   <div class="ensupport">      
      ...
      <div style="display:none;">
        ...
        <span class="img_tooltip" ><img src="<?php echo BASE_URL.'/Default/skin/nobel/test/media/icon-mobile.gif'; ?>" alt=""></span>
                ...
                <br>
                <span class="img_tooltip"><a title="Hỗ trợ Skype " href="skype:<?php  echo pzk_config('vn_skype')?>?chat"><img src="<?php echo BASE_URL.'/Default/skin/nobel/test/media/icon-skype.gif'; ?>" alt=""></a>
                <a href="ymsgr:sendIM?<?php  echo pzk_config('vn_yahoo')?>" title="Hỗ trợ Yahoo"><img src="<?php echo BASE_URL.'/Default/skin/nobel/test/media/icon-ym.gif'; ?>" alt=""> </a> 
                </span>
