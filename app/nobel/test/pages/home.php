<Page id="page" charset="utf-8" title="Phần mềm khảo sát năng lực toàn diện">
	<Home.Head id="head" layout="home/head" charset="utf-8">
		...
		<Html.Css src="/Default/skin/nobel/test/css/welcome.css" />
		
        <Html.Js src="/3rdparty/Validate/dist/jquery.Validate.js" />
		
	</Home.Head>
	
	<Welcome id="welcome" layout="home/welcome"/>
</Page>
