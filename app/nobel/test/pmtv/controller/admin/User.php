...
class PzkAdminUserController extends PzkGridAdminController {
	...
	public $selectFields = '`user`.*, areacode.name as areaname, creator.name as creatorName, modifier.name as modifiedName';
	public $addFields = 'name, username,password,confirmpassword, email, address, phone, birthday, areacode, school,class, classname, status, registeredAtSoftware, registeredAtSite';
	public $editFields = 'name, username,password,confirmpassword, email, address, phone, birthday,areacode, school,class, classname, status, registeredAtSoftware, registeredAtSite';
	...
	public $logable = true;
	public $logFields = 'name, username,password, email, address, phone, birthday, areacode, school,class, classname, status';
