<Core.Application id="app" name="nobel_hns" dispatcher="ControllerBased" 
	gsv="DJBoN802jfeoHdZJX1oM0vqdSuVjiqQ_0t4dHq0zEf4">
	<Core.Database.ArrayCondition id="conditionBuilder" />
	<Core.Database id="db" host="fulllooksongngu.com"
		user="admin_hns" password="nn123456" dbName="admin_hns" />
	...
	<Core.Rewrite.Request pattern="^\/practice\/class-([*class*][\d]+)\/subject-[\w\-]+-([*subject*][\d]+)\/topic-[\w\-]+-([*topic*][\d]+)\/homework-([*homework*][\d]+)$" 
		route="/Practice/doHomeworkQuestion/$2" queryParams="class,subject,homework,topic"/>
