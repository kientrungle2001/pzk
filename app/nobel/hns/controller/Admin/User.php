...
class PzkAdminUserController extends PzkGridAdminController {
	...
	public $addFields = 'name, username,password,confirmpassword, email, address, phone, birthday, areacode, district, school, class, classname, status, registeredAtSoftware, registeredAtSite';
	public $editFields = 'name, username,password,confirmpassword, email, address, phone, birthday, areacode, district, school, class, classname, status, registeredAtSoftware, registeredAtSite';
