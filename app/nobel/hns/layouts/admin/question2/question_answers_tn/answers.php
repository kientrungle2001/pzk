...
<form role="form" method="post" action="{url /admin_}{controller.module}/edit_tnPost">
	...
	<div class="form-group col-xs-12">
  	...
  	<div class="margin-top-20">
	  	<div class="col-xs-4">
			...
			<a class="btn btn-default" href="{url /admin_}{? echo pzk_request()->getController(); ?}/{item[questionId]}">Quay Lại</a>
		</div>
	</div>
</form>
