...
<script src="<?=BASE_URL?>/Default/skin/nobel/test/js/jquery.rwdImageMaps.min.js"></script>

<div id="welcome">
	<img src="/Default/skin/nobel/test/media/home.jpg" usemap="#login_Map"/>
	<map name="login_Map" id="login_Map" data-toggle="modal" data-target=".bs-example-modal-lg">
         <area shape="circle" coords="1985,865,120" alt="login" href="javascript:void(0)" title="Click vào để đăng nhập" id="login" class="mapping">
    </map>
			      	...
			      	<div class="modal-body">
				    	...
				    	<form id="registerForm" class="register form-horizontal margin-top-20" onsubmit="return pzk_{data.id}.register()">
				    		<div class="form-group margin-top-10">
						    	...
						    	<div class="clearfix"></div>
						    	<div class="col-xs-4 col-xs-offset-2 margin-top-10 ">
						    		<label for="captcha">Tỉnh/ TP :</label>  <span class="validate">(*)</span>
